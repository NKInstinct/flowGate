...
Because flowGate is in active development and not yet submitted to BioConductor,
you will need to install it directly from GitHub. Installing packages from
GitHub is slightly more complex than installing normal R packages, so if you've
never done it before, here are some steps to follow:
